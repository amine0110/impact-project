...
if __name__ == '__main__':
    ...
    detect_model = TinyYOLOv3_onecls(inp_dets, device=device, config_file="human_falling_detect_tracks/Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg", weight_file="human_falling_detect_tracks/Models/yolo-tiny-onecls/best-model.pth")
